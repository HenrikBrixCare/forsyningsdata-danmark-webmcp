...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      sources,
      documentCheck: {
        sourceHandoffFound: hasAalborgAdapter,
        documentAutomaticallyFound: false,
    ...
    return NextResponse.json({ ok: false, country: "DK", addressId: id, error: "follow_up_sources_failed" }, { status: 502 });
  }
}
